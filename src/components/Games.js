    ...
    <Header />
        ...
        <div className="gameHistory">
            <div className="gameInfo">
                ...
                <h3>Result: 1 for 3 (33%)</h3>
                <h3>Location: Deep Creek Lake, MD</h3>
            ...
            <div className="gameInfo">
                ...
                <h3>Result: 1 for 2 (50%)</h3>
                <h3>Location: Walkersville, MD</h3>
